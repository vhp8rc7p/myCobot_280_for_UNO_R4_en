...
* Basic Settings
   ...
   * [4. First Time Installation](2-BasicSettings/4.FirstTimeInstallation/4-FirstTimeInstallation.md)
      * [4.0 First Time Installation (UNO R4)](2-BasicSettings/4.FirstTimeInstallation/4-FirstTimeInstallation-R4.md)
...
* Functions and applications
   * [5. Basic functions](3-FunctionsAndApplications/5.BasicFunction/README.md)
     ...
     * [5.1-R4 Development environment (UNO R4)](3-FunctionsAndApplications/5.BasicFunction/5.1-FunctionInstruction/DevelopmentEnvironment.md)
   ...
   * [6. Software Development Guide](3-FunctionsAndApplications/6.developmentGuide/README.md)
     * [6.1 Development and Use Based on Arduino UNO R4](3-FunctionsAndApplications/6.developmentGuide/Arduino/README.md)
     ...
     * [6.1-M5 Original Arduino guide (M5Stack / Mega2560)](3-FunctionsAndApplications/6.developmentGuide/Arduino/README-M5.md)
       * [6.1.1-M5 Environment Construction](3-FunctionsAndApplications/6.developmentGuide/Arduino/10.1-arduino_download-M5.md)
       * [6.1.2-M5 Simple Use](3-FunctionsAndApplications/6.developmentGuide/Arduino/10.2-arduino_use-M5.md)
       * [6.1.3-M5 API description](3-FunctionsAndApplications/6.developmentGuide/Arduino/10.3-api-M5.md)
       * [6.1.4-M5 Arduino library use](3-FunctionsAndApplications/6.developmentGuide/Arduino/10.4-arduinolib_use.md)
     ...
     * [6.2-M5 Original Python guide](3-FunctionsAndApplications/6.developmentGuide/python/README-M5.md)
       * [6.2.1-M5 Environment construction](3-FunctionsAndApplications/6.developmentGuide/python/1_download-M5.md)
       * [6.2.2-M5 API description](3-FunctionsAndApplications/6.developmentGuide/python/2_API-M5.md)
       * [6.2.3-M5 Joint control](3-FunctionsAndApplications/6.developmentGuide/python/3_angle-M5.md)
       * [6.2.4-M5 Coordinate Control](3-FunctionsAndApplications/6.developmentGuide/python/4_coord-M5.md)
       * [6.2.5-M5 IO Control](3-FunctionsAndApplications/6.developmentGuide/python/5_IO-M5.md)
     ...
     * [6.6-R4 Serial communication protocol (UNO R4 notes)](3-FunctionsAndApplications/6.developmentGuide/18-communication.md)
...
* Support and Service
   * [Troubleshooting (UNO R4)](4-SupportAndService/9.Troubleshooting/README-R4.md)
     * [R4 self-check](4-SupportAndService/9.Troubleshooting/9.7-r4-self-check.md)
     * [R4 software issues](4-SupportAndService/9.Troubleshooting/9.5-r4-software.md)
     * [R4 hardware issues](4-SupportAndService/9.Troubleshooting/9.6-r4-hardware.md)
     * [R4 FAQ](4-SupportAndService/9.Troubleshooting/9.8-r4-faq.md)
   ...
   * [Acknowledgments (this R4 guide)](5-Acknowledgments/5-Acknowledgments-R4.md)
